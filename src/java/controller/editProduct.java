...
public class editProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int flag = 0;
            if (v.elementAt(7).trim().isEmpty() || v.elementAt(7) == null) {
                flag = 1;
            } else {
                flag = 0;
            }
            ...
            if (flag == 1) {
                ...
                message = p.edit(v.elementAt(1), Integer.parseInt(v.elementAt(2)), Integer.parseInt(v.elementAt(3)), Double.parseDouble(v.elementAt(4)), Double.parseDouble(v.elementAt(5)), v.elementAt(7), userid, df.format(dts), Integer.parseInt(v.elementAt(0)), v.elementAt(6), v.elementAt(8));
            }
