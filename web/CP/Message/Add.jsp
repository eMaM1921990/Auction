                           ...
                           <div class="span12">
                            ...
                            <div class="box box-color box-bordered">
                                ...
                                <div class="box-content nopadding">
                                    <form action="../../AddMessage" method="POST" class='form-horizontal form-bordered'>
                                       ...
                                       <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-xlarge"><textarea name="CONTENT"  rows="10" cols="200" style="margin-left: 0px; margin-right: 0px; width: 1102px;"></textarea></div>
                                            </div>
                                        </div>
