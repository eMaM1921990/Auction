                        ...
                        <div class="span12">
                            ...
                            <div class="box box-color box-bordered">
                                ...
                                <div class="box-content nopadding">
                                    <form action="../../EditFees" method="POST" class='form-horizontal form-bordered' >
                                        
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="color: red">Fees ID</label>
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="idFEES" readonly value="${param.idFEES}">
