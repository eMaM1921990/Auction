			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="tables-dynamic.html">View</a>
						</li>
					</ul>
						...
						<div class="box">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable">
									...
									<tbody>
                                                                            <%db.pstm=db.con.prepareStatement("SELECT * FROM USERLIST,USER,USERTYPE WHERE USERTYPE.idUSERTYPE=USER.USERTYPE AND idUSER=USERLIST AND idUSERTYPE=?");
                                                                            db.pstm.setInt(1, 2);
