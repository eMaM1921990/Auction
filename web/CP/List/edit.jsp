                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="box box-color box-bordered">
                                <div class="box-title">
                                    <h3><i class="icon-th-list"></i> List Form</h3>
                                </div>
                                <div class="box-content nopadding">
                                    <form action="../../editList" method="POST" class='form-horizontal form-bordered' >
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="color: red">List ID</label>
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="idUSERLIST" readonly value="${param.idUSERLIST}">
                                        ...
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">List Name</label>
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="LISTNAME" value="${param.LISTNAME}">
