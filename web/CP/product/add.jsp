                        ...
                        <div class="span12">
                            ...
                            <div class="box box-color box-bordered">
                                ...
                                <div class="box-content nopadding">
                                    <form id="bb" action="../../addProduct" method="POST" class='form-horizontal form-bordered form-validate' enctype='multipart/form-data' >
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Product Name</label>
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="NAME" data-rule-required="true" data-rule-maxlength="20">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="QUANTITYONHAND" id="textfield" value="0" class="spinner input-mini">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Sell Price</label>
                                            <div class="controls">
                                                <input type="text" data-provide="typeahead" name="SELLPRICE" data-items="4" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Shipping Cost</label>
                                            <div class="controls">
                                                <input type="text" data-provide="typeahead" name="SHIPPINGCOST" data-items="4" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="check-line">
                                                    <input type="radio" id="c8" class='icheck-me' name="TRANSPORT" data-skin="square" data-color="blue" value="Yes"> <label class='inline' for="c7">Yes</label>
                                                </div>
                                                <div class="check-line">
