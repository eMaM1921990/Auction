                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="box box-color box-bordered">
                                <div class="box-title">
                                    <h3><i class="icon-th-list"></i> Product Form List</h3>
                                </div>
                                <div class="box-content nopadding">
                                    <form action="../../addProductToList" method="POST" class='form-horizontal form-bordered' >
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Product ID</label>
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="idPRODUCT" readonly value="${param.idPRODUCT}">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" name="NAME" readonly value="${param.NAME}">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="STARTDAY" id="textfield" class="input-medium datepick">

                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Time Of Start</label>
                                            <div class="controls">
