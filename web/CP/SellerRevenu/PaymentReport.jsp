                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box">
                                <div class="box-title">
                                    <h3>
                                        Payment Report From Date ${param.datefrom} To ${param.dateto}
                                    </h3>
                                </div>
                                    ...
                                    <table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                db.pstm = db.con.prepareStatement("SELECT SUM(FEES) AS TOTAL,USERNAME FROM AUCTIONWINNER,AUCTION,PRODUCT WHERE DATEAUCTION BETWEEN ? AND ?  AND PRODUCT_ID=idPRODUCT AND PRODUCTCREATEDBY=idUSER AND BUYPAID=? AND idUSER=? ORDER BY idUSER GROUP BY idUSER");
                                                db.pstm.setDate(1, sqldatefrom);
                                                db.pstm.setDate(2, sqldateto);
                                                db.pstm.setString(3, "N");
                                                db.pstm.setInt(4, login.getUserId());
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-orange"><%=rs.getString(1)%></span></td>
                                                <td>
                                                    <div class="aParent" style="height: 30px">
                                                        <div>
                                                            <form action="../SendInvoice" method="post">
                                                                <input type="hidden" name="datefrom" value="<%=sqldatefrom%>"/>
                                                                <input type="hidden" name="dateto" value="<%=sqldateto%>"/>
                                                                <input type="hidden" name="amount" value="<%=rs.getString(1)%>"/>
