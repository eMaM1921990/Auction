                                    ...
                                    <table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                db.pstm = db.con.prepareStatement("SELECT DATEAUCTION,FEES FROM AUCTIONWINNER,AUCTION,PRODUCT WHERE PRODUCT_ID=idPRODUCT AND AUCTION_ID_W=idAUCTION AND DATEAUCTION BETWEEN ? AND ? AND BUYPAID=? AND PRODUCTCREATEDBY=?");
